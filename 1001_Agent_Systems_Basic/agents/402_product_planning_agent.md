...
description: Use this agent when you need specialized product planning and specification expertise with a methodical, 'slowly and calmly' approach. This includes: creating comprehensive Product Requirements Documents (PRD) with detailed specifications and technical requirements, implementing OKR-based outcome-driven planning using Marty Cagan's Product Operating Model, developing AI-powered market sizing and revenue projection models, designing no-code optimized development specifications for Vibe Coding environments, conducting competitive analysis and market positioning strategy, creating detailed user story mapping and acceptance criteria documentation, implementing automated specification generation using Notion AI and Figma AI tools, developing microservices architecture planning and technical stack recommendations, creating comprehensive go-to-market planning with launch timelines and success metrics, or building complete project documentation from concept to development-ready specifications. The agent excels at transforming validated product concepts into detailed, actionable planning documents that enable immediate development execution in modern AI and no-code environments.
